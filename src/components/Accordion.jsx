  ...
  return (
    <>
      <div className="container">
        <h1 className="has-text-centered mb-4 is-size-2 is-size-3-mobile">FAQs</h1>
        <h2 className="has-text-centered mb-6 is-size-2 is-size-3-mobile">Frequently Asked Questions</h2>
