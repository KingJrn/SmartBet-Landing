          ...
          <div className="px-5">
            <div className="faq-drawer">
              ...
              <div className="faq-drawer__content-wrapper">
                <div className="faq-drawer__content">
                  <p>
                  To place a bet, open <a href="play.smartgame.tech">play.smartgame.tech</a> connect your wallet, navigate to the desired sports event or casino game, select your wager, and confirm transaction.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="faq-drawer">
              ...
              <div className="faq-drawer__content-wrapper">
                <div className="faq-drawer__content">
                  <p>
                  We support USDT on the binance smartchain network, Eth on base network, TON and Solana
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="faq-drawer">
              ...
              What type of odds does SmartGame use, and what do they represent?
              </label>
              <div className="faq-drawer__content-wrapper">
                <div className="faq-drawer__content">
                  <p>
                  SmartGame uses a dynamic odds system which ranges from 2X-10X at different times for our virtual games and a pool system for our live prediction games. </p>                </div>
              </div>
            </div>
            <div className="faq-drawer">
              <input
              ...
              <div className="faq-drawer__content-wrapper">
                <div className="faq-drawer__content">
                  <p>
                  No, currently we do not offer exciting welcome bonuses or ongoing promotions for either new and existing users. Check our social media page regularly to stay updated on the latest offers and boost your betting experience.                  </p>
                </div>
              </div>
            </div>
            <div className="faq-drawer">
              ...
              <div className="faq-drawer__content-wrapper">
                <div className="faq-drawer__content">
                  <p>
                  To be a SmartGame ambassador or an affiliate partner kindly send a mail containing your CV to <a href="mailto:smartgstech@gmail.com">smartgstech@gmail.com</a> </p>                </div>
              </div>
            </div>
          </div>
        </div>
